...
- Added first-use SSH host-key discovery and private persistent `known_hosts` storage to the Plesk Suite updater, followed by strict verification on every repository operation.
