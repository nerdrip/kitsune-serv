...
test('web mode authenticates and exposes a desktop-parity API', { timeout: 30000 }, async (t) => {
  ...
  const enrollmentRequest = { connectorId: 'managed-plesk', timestamp: Date.now(), nonce: crypto.randomBytes(16).toString('hex'), device: { name: 'Managed Plesk', platform: 'Linux', version: '3.1.2-r21', capabilities: ['plesk-sso', 'inventory'] } };
